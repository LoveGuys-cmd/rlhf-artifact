...
def main() -> None:
    ...
    if seeds != (42, 314, 2718) or methods != TRAIN_METHODS:
    ...
    primary_deltas = {
        ...
        for baseline in ("vanilla_ppo", "scalar_max_ppo")
    }
    primary = {
        baseline: {
            **dict(
    ...
    gates = {
        "primary_vs_mean_ppo": primary["vanilla_ppo"]["ci_low"] > 0.0,
    ...
    report = {
        "protocol": "stablemax-ppo-publication-v7-multiseed-terminal",
    ...
    report_path = args.output_dir / "PUBLICATION_V7_TERMINAL.json"
