...
The primary setting is \(N=32\).  Each trainable confirmatory method uses
...
stream, value of \(N\), optimizer class, policy architecture, and
...
The confirmatory evaluation fixes \(N=32\) for every method; no cross-\(N\)
